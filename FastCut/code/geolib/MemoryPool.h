...
#define _MEMORY_POOL_DECLARATION void* operator new(unsigned long);\
								 void* operator new(unsigned long, const char*,int);\
								 void operator delete(void* p);

#define _MEMORY_POOL_IMPLEMENATION(_TYPE) void* _TYPE::operator new(unsigned long) \
											{return CMemoryPool<_TYPE>::Allocate();} \
										  void _TYPE::operator delete(void* p) \
											{CMemoryPool<_TYPE>::Deallocate(p);} \
										  void* _TYPE::operator new(unsigned long, const char*,int) \
											{return CMemoryPool<_TYPE>::Allocate();}
